package run.mone.mcp.laborunion.server;
...
@Component
public class LaborunionMcpServer {
    private ServerMcpTransport transport;
    private McpSyncServer syncServer;

    public LaborunionMcpServer(ServerMcpTransport transport) {
        this.transport = transport;
    }

    public McpSyncServer start() {
        McpSyncServer syncServer = McpServer.using(transport)
                .serverInfo("laborunion_mcp", "1.0.0")
        ...
        LaborUnionFunction function = new LaborUnionFunction();
